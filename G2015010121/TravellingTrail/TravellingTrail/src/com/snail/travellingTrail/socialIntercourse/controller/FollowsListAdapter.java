...
public class FollowsListAdapter extends BaseAdapter implements OnClickListener
{
	...
	public FollowsListAdapter(ArrayList<Fan> datas, Context context)
	{
		this.datas = datas;
...
//		finalBitmap.display(avatarImageView, data.getFtprnt_Cmm_Us_Avatar());
	...
	public void onClick(final View v)
	{
		...
		long followId = datas.get( ((Integer)v.getTag()).intValue()).getUs_Fans_Fans_Id();
		intent.putExtra("Trvl_Us_Id", followId);
