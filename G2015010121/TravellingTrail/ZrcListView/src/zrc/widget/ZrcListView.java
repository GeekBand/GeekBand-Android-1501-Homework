...
public class ZrcListView extends ZrcAbsListView {
    ...
    //.......................
    private int mLastScrollMyState = OnScrollMyListener.SCROLL_STATE_IDLE;
    ...
    //.......................
    private OnScrollMyListener mOnScrollMyListener;
    ...
    //.......................
    public void setOnScrollListener(OnScrollMyListener l) {
    	mOnScrollMyListener = l;
        invokeOnItemScrollListener();
    }
    //.......................
    void invokeOnItemScrollListener() {
        if (mOnScrollMyListener != null) {
        	mOnScrollMyListener.onScroll(this, mFirstPosition, getChildCount(), mItemCount);
        }
        onScrollChanged(0, 0, 0, 0);
    }
    //.......................
    void reportScrollMyStateChange(int newState) {
        if (newState != mLastScrollMyState) {
            if (mOnScrollMyListener != null) {
                mLastScrollMyState = newState;
                mOnScrollMyListener.onScrollStateChanged(this, newState);
            }
        }
    }
    ...
    //.......................
    public static interface OnScrollMyStateListener{
        public static final int EDGE = 0;
        public static final int DOWN = 1;
        public static final int UP = 2;
        void onChange(int state);
    ...
    //.......................
    public static interface OnScrollMyListener {
        public static int SCROLL_STATE_IDLE = 0;
        public static int SCROLL_STATE_TOUCH_SCROLL = 1;
        public static int SCROLL_STATE_FLING = 2;
        public void onScrollStateChanged(ZrcListView view, int scrollState);
        public void onScroll(ZrcListView view, int firstVisibleItem, int visibleItemCount,
                int totalItemCount);
    }
